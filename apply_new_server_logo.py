...
IMG_PATH = r"C:\Users\kishore\.gemini\antigravity-ide\brain\fbd9983a-33ac-47d1-b10e-77a86d71c538\rf_cyber_kitsune_mascot_1788683651199.jpg"
ASSET_DEST = r"F:\antigravity\APEX VIBES\assets\server_icon.jpg"

# Copy to assets
try:
    shutil.copyfile(IMG_PATH, ASSET_DEST)
    print("Copied new logo to assets/server_icon.jpg")
